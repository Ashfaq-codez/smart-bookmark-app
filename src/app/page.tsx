...
export default async function Home() {
  ...
  return (
    // Neo-Brutalist Dotted Canvas Background
      ...
      <nav className="bg-white border-b-4 border-gray-900 py-3 sm:py-4 px-4 sm:px-6 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-base sm:text-xl font-black tracking-tight text-gray-900 ml-1 uppercase">
                Smart Bookmarks
              </h1>
            </div>
