      ...
      <nav className="bg-white border-b-4 border-gray-900 py-3 px-4 sm:px-6 sticky top-0 z-10">
        <div className="max-w-[1400px] mx-auto flex flex-wrap justify-between items-center gap-y-4">
            ...
            <div className="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 sm:w-8 sm:h-8 stroke-gray-900 stroke-[3px] drop-shadow-[2px_2px_0px_rgba(17,24,39,1)]">
                {/* Multi-color gradient for the ribbon */}
                <defs>
                ...
                <path fill="url(#multiGradient)" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" strokeLinejoin="round"/>
              </svg>
