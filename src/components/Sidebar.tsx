...
// New Minimalist Drawer Slide Icons
...
const PanelLeftCloseIcon = () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="9" y1="3" x2="9" y2="21"></line><path d="M17 9l-3 3 3 3"></path></svg>
...
export default function Sidebar(props: SidebarProps) {
  ...
  if (props.isCollapsed) {
    return (
      <aside className="w-full h-full flex flex-col bg-[#FBF9F4] dark:bg-[#151815] text-[#636A63] dark:text-[#9DA59D] font-sans border-r border-black/[0.04] dark:border-white/[0.04] items-center py-6">
  ...
  // 2. EXPANDED VIEW
  return (
    <aside className="w-full h-full flex flex-col bg-[#FBF9F4] dark:bg-[#151815] text-[#636A63] dark:text-[#9DA59D] font-sans border-r border-black/[0.04] dark:border-white/[0.04]">
      ...
      <div className="flex-1 overflow-y-auto [&::-webkit-scrollbar]:w-0 flex flex-col">
        ...
        <div className="px-6 pt-6 pb-2 flex justify-between items-center">
          ...
          <button onClick={() => props.setIsMobileMenuOpen(false)} className="text-[#737B73] hover:text-[#171A17] dark:hover:text-white transition-colors hidden lg:block">
             <PanelLeftCloseIcon />
          </button>
        </div>
      ...
      {/* FOOTER: Safely outside the scrolling div so pop-up floats over everything */}
