...
export default function BookmarkCard({
  ...
  // Backwards compatibility for old notes that saved content to description
  ...
  return (
    <>
      ...
      {/* ────────────────────────────────────────────────────────────
          DETAIL MODAL PORTAL (Un-nested to fix Input Focus bug)
          ──────────────────────────────────────────────────────────── */}
      {mounted && isModalOpen && createPortal(
        ...
        >
          <div 
            className="relative w-[100vw] sm:w-[95vw] md:w-[90vw] xl:w-[85vw] max-w-[1600px] h-[95vh] sm:h-[85vh] flex flex-col md:flex-row bg-white dark:bg-gray-900 border-t-4 sm:border-4 border-gray-900 dark:border-gray-700 rounded-t-3xl sm:rounded-3xl shadow-[0_16px_48px_rgba(0,0,0,0.5)] overflow-hidden"
          ...
          >
            ...
            <div className="w-full md:w-[40%] h-[60%] sm:h-[50%] md:h-full flex flex-col p-5 sm:p-8 md:p-10 overflow-y-auto">
              ...
              <div className="flex flex-col flex-1">
                {activeModalTab === 'edit' ? (
                  <div className="flex flex-col gap-4 py-1">
                    {/* Hide Title & URL editing if it's a Note, to protect the core snippet */}
                    {bookmark.type !== 'note' && (
                      <>
                        <div>
              ...
              <div className="pt-3 mt-4 border-t-2 border-gray-200 dark:border-gray-800 text-[10px] font-bold text-gray-400">
      ...
      {/* ────────────────────────────────────────────────────────────
          FULLSCREEN LIGHTBOX PORTAL (Un-nested)
          ──────────────────────────────────────────────────────────── */}
